...
{
    [SerializeField]bool hitShoulderBlades;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        //         Debug.Log(localPoint.x + " " + ((-halfCollWidth + shoulderBladesSize)*-1 + transform.position.x) + " " + -1*(halfCollWidth - shoulderBladesSize) + transform.position.x);
